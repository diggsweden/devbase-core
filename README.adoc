...
* **Security** - ClamAV, fail2ban, automatic security updates, lynis, secure SSH (ED25519) key generation, checksum verification and more
...
* (A simple GitHub-token to avoid RateLimiting - might be provided automatically by custom config)
