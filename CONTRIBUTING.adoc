...
* https://codeberg.org/itiquette/gommitlint[gommitlint] (commit check)
* shellcheck, shfmt, yamlfmt (via mise)
...
$ just lint-all     # Only linting
$ just lint-commits # Only commit message check
----
...
For further guidance on how to get started with Development, see the link:./docs/development.adoc[Development Guide].
