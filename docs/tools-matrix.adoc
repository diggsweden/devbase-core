...
* `dot/.config/devbase/custom-tools.yaml` - Custom tool version specifications
* `dot/.config/devbase/apt-packages.txt` - APT package list
* `dot/.config/devbase/vscode-extensions.yaml` - VSCode extension specifications
